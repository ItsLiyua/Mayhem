...
craftingTable.addShapedMirrored("mekanism/module_base/elecanium", <item:mekanism:module_base>, [
...
craftingTable.addShapedMirrored("mekanism/module_base/shyrestone", <item:mekanism:module_base>.grow(1), [
    [<item:aoa3:lyon_nugget>, <item:aoa3:ghoulish_ingot>, <item:aoa3:lyon_nugget>],
