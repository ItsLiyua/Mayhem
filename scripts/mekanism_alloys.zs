...
<recipetype:mekanism:metallurgic_infusing>.addRecipe("mekanism/atomic_alloy_from_elecanium", ItemStackIngredient.from(<item:aoa3:elecanium_ingot>), InfusionStackIngredient.from(<infuse_type:crafttweaker:lunar_infuse_type> * 10), <item:mekanism:alloy_atomic>);
<recipetype:mekanism:metallurgic_infusing>.addRecipe("mekanism/atomic_alloy_from_lunar", ItemStackIngredient.from(<item:aoa3:lunar_ingot>), InfusionStackIngredient.from(<infuse_type:crafttweaker:elecanium_infuse_type> * 10), <item:mekanism:alloy_atomic>);
